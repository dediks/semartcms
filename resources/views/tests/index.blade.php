...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-button">
        <a href="{{ route('tests.create')}}" class="btn btn-primary btn-icon icon-right">Create New <i class="fas fa-plus"></i></a>
    </div>
  </div>
...
<th> Price</th>
                                ...
                                <tr>
                                    <td>{{ $no }}</td>
                                    <td>{{ str_limit($test->title, $limit = 50, $end ="...") }}</td>
<td>{{ str_limit($test->price, $limit = 50, $end ="...") }}</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @deletebutton([
                                            'id' => $test->id,
                                            'route' => route('tests.destroy', $test->id)
                                        ])
