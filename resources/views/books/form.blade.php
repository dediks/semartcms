                ...
                'validation'=>[
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">            
                            <button class="btn btn-primary" type="button" data-id="categories" id="selectRelation" onclick="selectRelatedRelation('categories','many-many','belongsToMany')")>Select categories</button>
                            <div id="view_selected_categories" class="mt-1">No categories selected</div>
                        </div>
