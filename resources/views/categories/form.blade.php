                ...
                'validation'=>[
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">            
                            <button class="btn btn-primary" type="button" data-id="books" id="selectRelationbooks" onclick="selectRelatedRelation('books','many-many','belongsToMany', 1)")>Select books</button>
