...
@field([
                ...
                'validation'=>[
                    ...
                    <div class="form-group row mb-4">
                        <label for="field-title" class="col-form-label text-md-right col-12 col-md-3 col-lg-3 ">comments
                        </label>
        
                        <div class="col-sm-12 col-md-7">            
                            <button class="btn btn-primary" type="button" data-id="comments" id="selectRelationcomments" onclick="selectRelatedRelation('comments','one-many','hasMany')")>Select comments</button>
                            <div id="view_selected_comments" class="mt-1">Nocomments selected</div>
                        </div>
                        <input type="hidden" value="" name="temp_data_selected[]" id="temp_data_selected">
                        <input type="hidden" value="comments,one-many,hasMany" name="data_target" id="data_target">
                    </div>

                    <div class="form-group row mb-4">
                        <label for="field-title" class="col-form-label text-md-right col-12 col-md-3 col-lg-3 ">Author
                        </label>
        
                        <div class="col-sm-12 col-md-7">            
                            <button class="btn btn-primary" type="button" data-id="Author" id="selectRelationAuthor" onclick="selectRelatedRelation('Author','one-many','belongsTo')")>Select Author</button>
                            <div id="view_selected_Author" class="mt-1">NoAuthor selected</div>
                        </div>
                        <input type="hidden" value="" name="temp_data_selected[]" id="temp_data_selected">
                        <input type="hidden" value="Author,one-many,belongsTo" name="data_target" id="data_target">
                    </div>
