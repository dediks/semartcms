...
<th> orangs</th>
                                ...
                                <tr>
                                    <td class="text-center align-middle"><input type="checkbox" class="form-check-input" id="checkbox_$phones" name="cb_$phones[]"></td>
                                    <td>{{ str_limit($phone->nomor, $limit = 50, $end ="...") }}</td>
<td><button type="button" class="btn btn-info" id="btnorangs" data-relation ="orangs" onclick="showRelation({{ $phone->id }}, 'phone','orangs')">Show orangs</button></td>
