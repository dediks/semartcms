      ...
      buttons: [
        {
          ...
          handler: function(modal) {
            window.__modalToggle__ = me;
            window.__modal__ = modal;

            eval(me.data('confirm-yes'));

            delete window.__modalToggle__;
            delete window.__modal__;
          }
        },
        {
...
// Global
  ...
  $("[data-toggle='sidebar']").click(function() {
    ...
    if(body.hasClass('sidebar-wide')) return false;
